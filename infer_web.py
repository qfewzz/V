...
"""
print('--------------------------------')
params_list = list(sys.argv)
global_params_json = base64.b64decode(params_list[1]).decode('utf-8')
params_list.pop(1)
sys.argv = params_list
# print(global_params_json)
global_params_dict: dict = json.loads(global_params_json)
print('--------------------------------')
"""
...
def preprocess_dataset(trainset_dir, exp_dir, sr, n_p):
    print_locals('process data', locals())
    sr = sr_dict[sr]
...
def click_train(
    ...
    print_locals('function :click_train:', locals())
    # 生成filelist
...
def train_index(exp_dir1, version19):
    print_locals('train feature index', locals())
...
def print_locals(title, params):
    print('-' * 50)
    # print(f'({title}):')
    # print('\n'.join([f"{key} : {value}" for key, value in params.items()]))
    print(f'{title} {json.dumps(params)}')
    print('-' * 50)
